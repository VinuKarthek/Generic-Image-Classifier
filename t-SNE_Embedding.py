...
with open(metadata, 'w') as metadata_file:
    #print(np.nonzero(mnist.test.labels[::1])[1:])
    #print(np.nonzero(mnist.test.labels[::1])[1:][0][0])
...
#tensorboard --logdir="D:\Python\Tensorflow\Neural_Networks\Image Classifier\Generic_Classifier\Config\Checkpoints\Tensorboard\mnist_t-SNE_Standalone" 